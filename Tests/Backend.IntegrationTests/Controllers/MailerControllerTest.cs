...
{
    public class MailerControllerTest : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        private readonly CustomWebApplicationFactory<Startup> FWebAppFactory;
        
        public MailerControllerTest(CustomWebApplicationFactory<Startup> AWebAppFactory)
