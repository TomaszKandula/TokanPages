...
{
    public class SubscribersControllerTest : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        private readonly CustomWebApplicationFactory<Startup> FWebAppFactory;

        public SubscribersControllerTest(CustomWebApplicationFactory<Startup> AWebAppFactory)
