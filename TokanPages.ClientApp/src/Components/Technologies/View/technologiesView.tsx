                        ...
                        <div className="bulma-columns">
                            <div className="bulma-column">
                                <Animated dataAos="fade-up" className="is-flex is-align-items-center py-2">
                                    <Skeleton isLoading={data.isLoading} mode="Circle" width={40} height={40}>
                                    <Icon
                                        name="CodeBraces"
                                        size={1.2}
                                    ...
                                    <Skeleton isLoading={data.isLoading} mode="Text" width={200} className="ml-2">
                                    <h3 className="is-size-4 py-5 has-text-black">{technology?.title1}</h3>
                                    </Skeleton>
                                </Animated>
                                <Animated dataAos="fade-up">
                                    <Skeleton isLoading={data.isLoading} mode="Text" height={100}>
