                    ...
                    <Box pt={8} pb={10}>
                        ...
                        <Carousel showArrows={true} infiniteLoop={true} showThumbs={false} showStatus={false} autoPlay={true} interval={6100}>
                            <Box className={classes.box_padding}>
                                {props.isLoading 
                                    ? <Skeleton variant="rect" height="150px" width="150px" /> 
                                    : renderImage(TESTIMONIALS_PATH, props.content?.photo1, classes.image)}
                                ...
                                <Typography className={classes.commendation}>
                            ...
                            <Box className={classes.box_padding}>
                                {props.isLoading 
                                    ? <Skeleton variant="rect" height="150px" width="150px" /> 
                                    : renderImage(TESTIMONIALS_PATH, props.content?.photo2, classes.image)}
                                <Typography className={classes.title}>
                            ...
                            <Box className={classes.box_padding}>
                                {props.isLoading 
                                    ? <Skeleton variant="rect" height="150px" width="150px" /> 
                                    : renderImage(TESTIMONIALS_PATH, props.content?.photo3, classes.image)}
                                <Typography className={classes.title}>
