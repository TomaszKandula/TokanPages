...
const LinkedinIcon = (props: IconBaseProps): React.ReactElement => (
    <svg fill="#000000" width={`${props.size}rem`} height={`${props.size}rem`} viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
...
const GithubIcon = (props: IconBaseProps): React.ReactElement => (
    <svg width={`${props.size}rem`} height={`${props.size}rem`} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const InstgramIcon = (props: IconBaseProps): React.ReactElement => (
    <svg width={`${props.size}rem`} height={`${props.size}rem`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
