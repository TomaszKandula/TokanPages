...
const selfXssWarningContent = {
    pol: {
        ...
        secondLineText: "Jeśli ktoś polecił Ci edytować stronę w ten sposób, jest to próba ataku i wyłudzenia danych.\nNic tutaj nie wklejaj ani nie wpisuj.",
    ...
    eng: {
        ...
        secondLineText: "If someone told you edit a page in this way, it is an attempt of attack and phishing.\nDo not paste or type anything here.",
        thirdLineText: "Close the tool window (click the \"X\" in the top right corner).\nInform us about an attempted attack."
    }
};
...
export const printSelfXssWarning = (): void => 
{
    ...
    setTimeout(() => 
    {
        console.log("%c" + translations.bannerText, "color:" + selfXssWarnignConfig.banner.color + "; font-weight:" + selfXssWarnignConfig.banner.fontWeight + ";" + "font-size:" + selfXssWarnignConfig.banner.fontSize + ";");
        console.log(translations.firstLineText);
        console.log("%c" + translations.secondLineText, "font-weight:" + selfXssWarnignConfig.secondLine.fontWeight + ";" + "font-size:" + selfXssWarnignConfig.secondLine.fontSize + ";");
