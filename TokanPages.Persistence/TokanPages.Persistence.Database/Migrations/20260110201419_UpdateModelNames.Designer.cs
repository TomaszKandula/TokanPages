...
namespace TokanPages.Persistence.Database.Migrations
{
    ...
    [Migration("20260110201419_UpdateModelNames")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.Article.Article", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.Article.ArticleCount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.Article.ArticleLike", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.Article.ArticleTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.Invoicing.UserBankAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.Invoicing.UserCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.Photography.UserPhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.User.DefaultPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.User.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.User.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.User.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.User.UserPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.User.UserRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.User.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.User.UserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.Article.Article", b =>
                {
                    ...
                    b.HasOne("TokanPages.Backend.Domain.Entities.User.User", "User")
                        .WithMany("Articles")
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.Article.ArticleCount", b =>
                {
                    b.HasOne("TokanPages.Backend.Domain.Entities.Article.Article", "Article")
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.Invoicing.BatchInvoice", b =>
                {
                    ...
                    b.HasOne("TokanPages.Backend.Domain.Entities.Invoicing.UserBankAccount", "UserBankAccount")
                        .WithMany("BatchInvoices")
                        .HasForeignKey("UserBankAccountId")
                        .IsRequired()
                        .HasConstraintName("FK_BatchInvoices_UserBankAccount");

                    b.HasOne("TokanPages.Backend.Domain.Entities.Invoicing.UserCompany", "UserCompany")
                        .WithMany("BatchInvoices")
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.Photography.Album", b =>
                {
                    ...
                    b.HasOne("TokanPages.Backend.Domain.Entities.Photography.UserPhoto", "UserPhoto")
                        .WithMany("Albums")
            ...
            modelBuilder.Entity("TokanPages.Backend.Domain.Entities.User.DefaultPermission", b =>
                {
                    b.HasOne("TokanPages.Backend.Domain.Entities.User.Permission", "Permission")
                        .WithMany("DefaultPermissions")
                        .HasForeignKey("PermissionId")
                        .IsRequired()
                        .HasConstraintName("FK_DefaultPermissions_Permissions");

                    b.HasOne("TokanPages.Backend.Domain.Entities.User.Role", "Role")
                        .WithMany("DefaultPermissions")
