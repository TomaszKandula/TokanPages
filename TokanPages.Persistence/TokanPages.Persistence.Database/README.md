...
```bash
./SqlPackage /Action:Publish /SourceFile:bin/Debug/TokanPages.Persistance.Database.dacpac /TargetServerName:localhost /TargetDatabaseName:TokanPages.Persistance.Database
```
