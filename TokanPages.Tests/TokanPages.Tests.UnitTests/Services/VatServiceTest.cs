...
public class VatServiceTest : TestBase
{
	...
	private static List<VatNumberPattern> GetPatternList()
	{
		...
		{
			new() { Id = Guid.NewGuid(), CountryCode = "PL", Pattern = @"^PL[ ]?\d{10}$|^\d{3}-\d{3}-\d{2}-\d{2}$|^\d{3}-\d{2}-\d{2}-\d{3}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "AT", Pattern = @"^AT[ ]?U\d{8}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "BE", Pattern = @"^BE[ ]?(0?\d{9})$" },
			new() { Id = Guid.NewGuid(), CountryCode = "BG", Pattern = @"^BG[ ]?\d{9,10}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "CY", Pattern = @"^CY[ ]?\d{8}[a-zA-z]{1}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "CZ", Pattern = @"^CZ[ ]?\d{8,10}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "DK", Pattern = @"^DK[ ]?\d{8}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "EE", Pattern = @"^EE[ ]?\d{9}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "FI", Pattern = @"^FI[ ]?\d{8}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "FR", Pattern = @"^FR[ ]?(([a-zA-Z]{1})|(\d{1}))(([a-zA-Z]{1})|(\d{1}))(\d{9})$" },
			new() { Id = Guid.NewGuid(), CountryCode = "EL", Pattern = @"^EL[ ]?\d{9}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "ES", Pattern = @"^ES[ ]?((([a-zA-Z]{1})|(\d{1}))(\d{7})(([a-zA-Z]{1})|(\d{1})))$" },
			new() { Id = Guid.NewGuid(), CountryCode = "NL", Pattern = @"^NL[ ]?\d{9}B{1}\d{2}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "IE", Pattern = @"^IE[ ]?\d{1}(([a-zA-Z]{1})|(\d{1})|(\+{1})|(\*{1}))\d{5}[a-zA-Z]{1,2}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "LT", Pattern = @"^LT[ ]?((\d{9})|(\d{12}))$" },
			new() { Id = Guid.NewGuid(), CountryCode = "LU", Pattern = @"^LU[ ]?\d{8}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "LV", Pattern = @"^LV[ ]?\d{11}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "MT", Pattern = @"^MT[ ]?\d{8}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "DE", Pattern = @"^DE[ ]?\d{9}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "PT", Pattern = @"^PT[ ]?\d{9}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "RO", Pattern = @"^RO[ ]?\d{2,10}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "SK", Pattern = @"^SK[ ]?\d{9,10}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "SI", Pattern = @"^SI[ ]?\d{8}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "SE", Pattern = @"^SE[ ]?\d{12}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "HU", Pattern = @"^HU[ ]?\d{8}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "GB", Pattern = @"^GB[ ]?(((\d{2})|(G{1}D{1})|(H{1}A{1}))((\d{3})|(\d{7})|(\d{10})))$" },
			new() { Id = Guid.NewGuid(), CountryCode = "IT", Pattern = @"^IT[ ]?\d{11}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "CH", Pattern = @"^CH[ ]?\d{6}$" },
			new() { Id = Guid.NewGuid(), CountryCode = "HR", Pattern = @"^HR[ ]?\d{11}$" }
		};
	}
}