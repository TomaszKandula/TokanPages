...
public class CreatePaymentDefaultCommandValidatorTest : TestBase
{
    [Fact]
    public async Task GivenValidInput_WhenCreatePaymentDefault_ShouldSucceed()
    {
        // Arrange
        var command = new CreatePaymentDefaultCommand
        {
            UserId = Guid.NewGuid(),
        ...
        // Act
        var validator = new CreatePaymentDefaultCommandValidator();
    ...
    [Fact]
    public async Task GivenEmptyInput_WhenCreatePaymentDefault_ShouldFail()
    {
        // Arrange
        var command = new CreatePaymentDefaultCommand
        {
