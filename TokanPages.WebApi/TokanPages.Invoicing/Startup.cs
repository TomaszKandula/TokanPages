...
{
    private const string ApiName = "Invoicing API";

    private const string DocVersion = "v1";

    private static readonly string[] XmlDocs = { "TokanPages.Invoicing.xml", "TokanPages.Invoicing.Dto.xml" };
    ...
    public void Configure(IApplicationBuilder builder)
    {
        ...
        builder.UseEndpoints(endpoints =>
        {
            ...
            endpoints.MapGet("/", context 
                => context.Response.WriteAsync("Invoicing API"));
        });
