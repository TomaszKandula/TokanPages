...
namespace TokanPages.Subscribers;
...
{
    private const string ApiName = "Subscribers API";

    private const string DocVersion = "v1";

    private static readonly string[] XmlDocs = { "TokanPages.Subscribers.xml", "TokanPages.Subscribers.Dto.xml" };
    ...
    public void Configure(IApplicationBuilder builder)
    {
        ...
        builder.UseEndpoints(endpoints =>
        {
            ...
            endpoints.MapGet("/", context 
                => context.Response.WriteAsync("Subscribers API"));
        });
