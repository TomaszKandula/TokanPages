...
{
    private const string ApiName = "Users API";

    private const string DocVersion = "v1";

    private static readonly string[] XmlDocs = { "TokanPages.Users.xml", "TokanPages.Users.Dto.xml" };
    ...
    public void Configure(IApplicationBuilder builder)
    {
        ...
        builder.UseEndpoints(endpoints =>
        {
            ...
            endpoints.MapGet("/", context 
                => context.Response.WriteAsync("Users API"));
        });
