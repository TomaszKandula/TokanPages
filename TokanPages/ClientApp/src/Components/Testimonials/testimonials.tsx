...
export default function Testimonials()
{
    ...
    const joannaPhoto = TESTIMONIALS_PATH + content.photo1;
    const adamaPhoto = TESTIMONIALS_PATH + content.photo2;
    const scottPhoto = TESTIMONIALS_PATH + content.photo3;
                    ...
                    <Box pt={8} pb={10}>
                        ...
                        <Carousel showArrows={true} infiniteLoop={true} showThumbs={false} showStatus={false} autoPlay={true} interval={6100}>
                            <Box className={classes.boxPadding}>
                                <img src={joannaPhoto} className={classes.img} alt="" />
                            ...
                            <Box className={classes.boxPadding}>
                                <img src={adamaPhoto} className={classes.img} alt="" />
                                <Typography variant="h4" component="h3" align="center" className={classes.title}>
                                    {content.name2}
                                </Typography>
                                <Typography variant="subtitle1" component="h4" align="center" className={classes.subtitle}>
                            ...
                            <Box className={classes.boxPadding}>
                                <img src={scottPhoto} className={classes.img} alt="" />
                                <Typography variant="h4" component="h3" align="center" className={classes.title}>
                                    {content.name3}
                                </Typography>
                                <Typography variant="subtitle1" component="h4" align="center" className={classes.subtitle}>
