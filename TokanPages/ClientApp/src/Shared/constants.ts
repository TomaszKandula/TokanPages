...
export const GET_WRONG_PAGE_PROMPT_CONTENT = `${APP_STORAGE}/content/components/wrongPage.json`;
...
export const LIKES_HINT_FOR_ANONYM = "You may give up to {LEFT_LIKES} thumbs up!";
export const LIKES_HINT_FOR_USER = "You may give up to {LEFT_LIKES} thumbs up!";
