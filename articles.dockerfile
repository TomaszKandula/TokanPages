...
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Articles/bin/Release/net8.0" .
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Articles.Dto/bin/Release/net8.0" .
