...
# WEBAPI
COPY --from=PROJECTS "/app/TokanPages.WebApi/TokanPages.Articles/bin/Release/net6.0" .
COPY --from=PROJECTS "/app/TokanPages.WebApi/TokanPages.Articles.Dto/bin/Release/net6.0" .
...
EXPOSE 80
ENTRYPOINT ["dotnet", "TokanPages.Articles.dll"]
