...
COPY --from=PROJECTS "/app/TokanPages.WebApi/TokanPages.Chat/bin/Release/net6.0" .
COPY --from=PROJECTS "/app/TokanPages.WebApi/TokanPages.Chat.Dto/bin/Release/net6.0" .
