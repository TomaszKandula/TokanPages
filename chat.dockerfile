...
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Chat/bin/Release/net8.0" .
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Chat.Dto/bin/Release/net8.0" .
