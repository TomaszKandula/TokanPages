...
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Content/bin/Release/net8.0" .
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Content.Dto/bin/Release/net8.0" .
