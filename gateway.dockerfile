...
COPY --from=projects "/app/TokanPages.Backend/TokanPages.Backend.Application/bin/Release/net8.0" .
COPY --from=projects "/app/TokanPages.Backend/TokanPages.Backend.Configuration/bin/Release/net8.0" .
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Gateway/bin/Release/net8.0" .
