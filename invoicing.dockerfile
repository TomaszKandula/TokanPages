...
COPY --from=PROJECTS "/app/TokanPages.Services/TokanPages.Services.TemplateService/bin/Release/net6.0" .
COPY --from=PROJECTS "/app/TokanPages.Services/TokanPages.Services.VatService/bin/Release/net6.0" .

# WEBAPI
COPY --from=PROJECTS "/app/TokanPages.WebApi/TokanPages.Invoicing/bin/Release/net6.0" .
COPY --from=PROJECTS "/app/TokanPages.WebApi/TokanPages.Invoicing.Dto/bin/Release/net6.0" .
...
EXPOSE 80
ENTRYPOINT ["dotnet", "TokanPages.Invoicing.dll"]
