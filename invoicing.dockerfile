...
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Invoicing/bin/Release/net8.0" .
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Invoicing.Dto/bin/Release/net8.0" .
