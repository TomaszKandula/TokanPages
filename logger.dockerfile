...
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Logger/bin/Release/net6.0" .
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Logger.Dto/bin/Release/net6.0" .
