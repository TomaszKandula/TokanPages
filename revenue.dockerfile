...
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Revenue/bin/Release/net8.0" .
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Revenue.Dto/bin/Release/net8.0" .
