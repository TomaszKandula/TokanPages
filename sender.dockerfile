...
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Sender/bin/Release/net8.0" .
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Sender.Dto/bin/Release/net8.0" .
