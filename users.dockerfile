...
COPY --from=projects "/app/TokanPages.Services/TokanPages.Services.CookieAccessorService/bin/Release/net8.0" .
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Users/bin/Release/net8.0" .
COPY --from=projects "/app/TokanPages.WebApi/TokanPages.Users.Dto/bin/Release/net8.0" .
